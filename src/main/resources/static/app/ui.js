...
var UI = {
    ...
    inhibit_reconnect: false,
    reconnect_callback: null,
    reconnect_password: '11111111',
    ...
    initSettings: function() {
        ...
        UI.initSetting('password', '11111111');
    ...
    * ------v------*/
    ...
    updateSetting: function(name) {
        ...
        if (typeof ctrl !== 'undefined' && ctrl !== null && ctrl.type === 'checkbox') {
            ctrl.checked = value;

        } else if (typeof ctrl !== 'undefined' && ctrl !== null && typeof ctrl.options !== 'undefined') {
    ...
    getSetting: function(name) {
        ...
        try {
            if (typeof val !== 'undefined' && val !== null && typeof ctrl !== 'undefined' && ctrl !== null && ctrl.type === 'checkbox') {
    ...
    connect: function(event, password) {
        ...
        if (typeof password === 'undefined') {
            password = WebUtil.getConfigVar('password', '11111111');
